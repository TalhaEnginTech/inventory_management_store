...
class SuppliersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create supplier" do
    assert_difference('Supplier.count') do
      post suppliers_url, params: { supplier: { cnic: @supplier.cnic, name: @supplier.name } }
    end
  ...
  test "should update supplier" do
    patch supplier_url(@supplier), params: { supplier: { cnic: @supplier.cnic, name: @supplier.name } }
